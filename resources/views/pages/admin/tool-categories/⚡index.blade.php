...
new #[Layout('layouts.admin-app')] #[Title('Tool Categories')] class extends Component {
    use WithPagination;
    ...
    public function toggleStatus(int $id): void
    {
        ...
        $this->dispatch('toast', message: 'Tool category status updated successfully.', type: 'success');
    }
    ...
    public function delete(int $id): void
    {
        ...
        $this->dispatch('toast', message: 'Tool category deleted successfully.', type: 'success');
    }
};
?>
        ...
        <div class="flex flex-col justify-between gap-4 md:flex-row md:items-center">
            <div>
                ...
                <p class="text-xs font-body-md text-secondary md:text-body-md">
                    Manage categories for your tools section.
                </p>
            </div>
            ...
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                ...
                <a
                    href="{{ route('admin.tool-categories.create') }}"
                    wire:navigate
            ...
            <div class="overflow-x-auto">
                <table class="w-full border-collapse text-left">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        @forelse ($this->toolCategories() as $category)
                            <tr
                                wire:key="tool-category-{{ $category->id }}"
                            ...
                            >
                                ...
                                <td class="px-6 py-4 text-right">
                                    ...
                                    >
                                        ...
                                        >
                                            <a
                                                href="{{ route('admin.tool-categories.edit', $category) }}"
                                                wire:navigate
                                            ...
                                            <button
                                                ...
                                                wire:confirm="Are you sure you want to delete this tool category?"
                                ...
                                <td colspan="6" class="px-6 py-14 text-center">
                                    <div class="mx-auto flex max-w-sm flex-col items-center">
                                        ...
                                        <p class="mt-1 text-sm text-secondary">
                                            Create your first tool category to organize your tools.
                                        </p>
