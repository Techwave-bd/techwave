...
new #[Layout('layouts.admin-app')] #[Title('Edit Subcategory')] class extends Component {
    use WithFileUploads;
    ...
    public function mount(Subcategory $subcategory): void
    {
        ...
        $this->sort_order = (int) $subcategory->sort_order;
        $this->is_active = (bool) $subcategory->is_active;
    }
    ...
    protected function rules(): array
    {
        return [
            ...
            'slug' => ['required', 'string', 'max:180', Rule::unique('subcategories', 'slug')->ignore($this->subcategory->id)],
    ...
    public function update(): void
    {
        ...
        $imagePath = $this->subcategory->image;
    ...
    public function discard(): void
    {
        ...
        $this->icon = $this->subcategory->icon ?? '';
        $this->description = $this->subcategory->description ?? '';
        $this->sort_order = (int) $this->subcategory->sort_order;
        $this->is_active = (bool) $this->subcategory->is_active;
        $this->image = null;
...
<div>
    <div class="mb-10 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
            <h1 class="text-h1 font-h1 text-on-surface">Edit Subcategory</h1>
            <p class="mt-1 text-body-md font-body-md text-secondary">
                Update subcategory information, parent category, icon, order and visibility.
            </p>
        </div>
                ...
                <div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                    <div class="flex flex-col-reverse gap-3 sm:flex-row sm:items-center sm:justify-end">
                        ...
                        <button type="submit" wire:loading.attr="disabled"
                            ...
                            <span wire:loading.remove wire:target="update">Update Subcategory</span>
