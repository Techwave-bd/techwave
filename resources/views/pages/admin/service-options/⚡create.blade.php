...
new #[Layout('layouts.admin-app')] #[Title('Create Service Option')] class extends Component {
    use WithFileUploads;
    ...
    private function uniqueSlug(string $title): string
    {
        ...
        while (ServiceOption::query()->where('slug', $slug)->exists()) {
    ...
    {
        $this->reset(['service_id', 'card_title', 'detail_title', 'icon', 'short_description', 'overview', 'audience_title', 'audience_detail', 'meta_title', 'meta_description', 'meta_keywords', 'image', 'included_items', 'included_item', 'tags', 'tag']);
...
<div>
    <div class="mb-10 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
            <h1 class="text-h1 font-h1 text-on-surface">Create Service Option</h1>
            <p class="mt-1 text-body-md font-body-md text-secondary">
                Create a service option to organize service plans under a service.
            </p>
        </div>
                ...
                <div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                    <div class="flex flex-col-reverse gap-3 sm:flex-row sm:items-center sm:justify-end">
                        ...
                        <button type="submit" wire:loading.attr="disabled"
                            ...
                            <span wire:loading.remove wire:target="save">Save Option</span>
