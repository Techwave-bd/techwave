...
new #[Title('My Compressed Images')] class extends Component {
    use WithPagination;

    public function delete(int $id): void
    {
        $image = UserCompressedImage::query()
...
<div class="min-h-screen text-white">
    <div class="mx-auto max-w-350 px-4 py-6 sm:px-6 lg:px-8">
        <div class="mb-8">
            ...
            <p class="mt-2 text-blue-100/60">Your backed-up compressed images. Backups are kept for 30 days.</p>
        </div>
        ...
        <div x-data="{ preview: null }" class="space-y-4">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="min-w-0">
                                ...
                                <div class="mt-0.5 flex flex-wrap items-center gap-x-2 gap-y-1 text-xs text-blue-100/50">
                                    <span class="rounded bg-white/8 px-1.5 py-0.5 uppercase">{{ $image->compressed_ext }}</span>
                                    <span>{{ number_format($image->original_size / 1024, 1) }} KB → {{ number_format($image->compressed_size / 1024, 1) }} KB</span>
            ...
            @empty
                <div class="rounded-2xl border border-white/15 bg-white/[0.07] p-12 text-center backdrop-blur-2xl">
                    ...
                    <p class="mt-2 text-sm text-blue-100/50">Compress images as a premium user to get 30-day backup.</p>
