                ...
                <div class="min-w-0 flex-1 p-4 sm:p-6 lg:p-8">
                    ...
                    <div class="space-y-4">
                        @forelse ($this->subscriptions() as $sub)
                            <div
                                class="rounded-2xl border border-white/15 bg-white/[0.07] p-5 shadow-[0_10px_30px_rgba(0,0,0,0.12)] backdrop-blur-2xl">
                                <div class="flex flex-wrap items-start justify-between gap-4">
                                    <div class="flex items-center gap-3">
                                        <div
                                            class="flex h-12 w-12 items-center justify-center rounded-xl bg-cyan-400/10 text-cyan-300">
                                            <span
                                                class="material-symbols-outlined">{{ $sub->toolCategory?->icon ?: 'build' }}</span>
                                        </div>
                                        <div>
